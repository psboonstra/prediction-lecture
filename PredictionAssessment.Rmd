...
author: "www.umich.edu/~philb/BDSI2021/PredictionAssessment.html"
date: "BDSI 2021; Univeristy of Michigan"
geometry: margin=0.5in
output: 
  ioslides_presentation:
    transition: 0.1
    css: ~/Desktop/Work/CV/Styles/temp_fancy.css
    includes:
...
#library(gganimate);
#library(animation);
#knitr::opts_knit$set(root.dir = "~/Desktop/Work/BDSI2021");
knitr::opts_chunk$set(echo = T, warning = F, message = F, cache = F);
knitr::knit_hooks$set(mysize = function(before, options, envir) {
  if (before) 
    return(options$size);
})
#animation::ani.options(ani.type = "png", 
#                       ani.dev = "png",
#                       interval = 0.15);
...
<img src="puzzle_pics/puzzle_pics.001.png" width="500" />

## Sort and build high contrast/color regions

<img src="puzzle_pics/puzzle_pics.003.png" width="500" />

## Sort into knob-and-hole combinations

<img src="puzzle_pics/puzzle_pics.002.png" width="500" />
...
g <- rasterGrob(readJPEG("aoc.jpg"), width=unit(1,"npc"), height=unit(1,"npc"), interpolate = FALSE)
ggplot(filter(roc_data, model == "forward_pruned", step == "validation")) + 
